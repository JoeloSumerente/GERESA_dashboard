...
* Exportar a CSV
sort ubigeo fecha
export delimited using "C:\Users\pc\Documents\GitHub\GERESA_dashboard\Clone Dashboard\DATA\source2_siscovid\output\dashboard-distrital.csv", replace
...
*tsset fecha
*tsfill
*export delimited using "${maindata}/data_distrital_wide.csv", replace
...
* Exportar a CSV
export delimited using "C:\Users\pc\Documents\GitHub\GERESA_dashboard\Clone Dashboard\DATA\source2_siscovid\output\dashboard-provincial.csv", replace
...
*export delimited using "${maindata}/data_provincial_wide.csv", replace
...
* Exportar a CSV
export delimited using "C:\Users\pc\Documents\GitHub\GERESA_dashboard\Clone Dashboard\DATA\source2_siscovid\output\dashboard-regional.csv", replace
