                           ...
                           tabPanel("Tasa de positividad molecular",
                                    tabsetPanel(
                                      tabPanel("Grafico", dygraphOutput("dygraph_dis_positividad_molecular"),
                                               ...
                                               p(div(strong("Eje X: "), em("Días."), style = "color:blue"), "El primer dia de la serie corresponde al 13/03/2020, fecha en la cual se reporta
...
#                                                tabsetPanel(
#                                                  tabPanel("Grafico", dygraphOutput("dygraph_dis_positividad_antigenica"),
#                                                           h4(strong("Descripción de los ejes")),
#                                                           p(div(strong("Eje Y: "), em("Tasa de positividad de pruebas antigenicas (promedio de 7 días)."), style = "color:blue")),
#                                                           p(div(strong("Eje X: "), em("Días."), style = "color:blue"), "El primer día de la serie corresponde al 13/03/2020, fecha en la cual se reportÃ³
#                                           el primer caso confirmado por COVID-19 en la región.")),
